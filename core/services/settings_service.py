...
class SettingsService:
    def get_runtime_settings_summary(self) -> RuntimeSettingsSummary:
        ...
        return RuntimeSettingsSummary(
            ...
            deepseek_key_masked=mask_secret(settings.deepseek_api_key),
    ...
    def save_runtime_settings(self, payload: LocalSettingsPayload) -> RuntimeSettingsSummary:
        ...
        merged = payload.model_copy(
            update={
                ...
                "deepseek_api_key": payload.deepseek_api_key or settings.deepseek_api_key,
                "deepseek_base_url": payload.deepseek_base_url or settings.deepseek_base_url,
                "deepseek_model": payload.deepseek_model or settings.deepseek_model,
